            ...
            <div class="col-xs-12">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                <td class="text-left">Chemical Hazards</td>
                                <td class="text-left">Link Type</td>
                        ...
                        <tbody>
                            <asp:repeater runat="server" id="repList">
                             ...
                             <%-- Date Posted My Date Posted Come--%>
                                         <td class="text-left"><img src="images/<%# Eval("fullfilepath") %>"></td>
	  							    </tr>
                                </ItemTemplate>
                                 <AlternatingItemTemplate>
                                    <tr class="table-row-alternate">
	  								    <td class="text-left"><a href="<%# Eval("fullfilepath") %>"><%# Eval("displayname") %></a></td>
                          <%-- Image Why Wont My Image Come --%>
                                        <td class="text-left">
                                            <%# IsUrl(Eval("fullfilepath").ToString()) ?  
                                            "<a href=" + Eval("fullfilepath").ToString() + "></a>"
